...
data_df = pd.read_csv(os.path.join("data", "labled_data_large.csv"), sep="\t")
print(data_df)
...
args = SentenceTransformerTrainingArguments(num_train_epochs=1, 
...
final_output_dir = "query_classifier_new"
